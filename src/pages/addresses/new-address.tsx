  ...
  return (
    <>
      ...
      <form
        ...
        className="z-20 bg-white absolute top-1/2 left-1/2 -translate-1/2 p-5 rounded-2xl space-y-5 lg:w-[600px]"
      >
        <h2 className="text-3xl font-primary font-semibold">Novo Endereço</h2>

        <div className="flex flex-col gap-2 p-4 rounded-lg border-2 border-black/20">
          <h3 className="font-bold text-base text-zinc-500 ">Endereço</h3>

          <div className="">
            <p className="font-semibold text-lg">Cep</p>
          ...
          <div className="flex gap-4 ">
            <label className="space-y-1 min-w-40">
              <p className="font-semibold text-lg">Número</p>
        ...
        <div className="p-4 rounded-lg border-2 border-black/20">
          ...
          <label className="space-y-1 flex-1">
            <p className="font-semibold text-lg text-nowrap">Nome</p>
          ...
          <div className="flex gap-4 mt-2">
            <label className="space-y-1 flex-1">
              <p className="font-semibold text-lg text-nowrap">CPF</p>
            ...
            <label className="space-y-1 flex-1">
              <p className="font-semibold text-lg text-nowrap">Telefone</p>
